          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><Link href="/cars" className="hover:text-white transition-colors">السيارات</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><Link href="/sell-car" className="hover:text-white transition-colors">بيع سيارة</Link></li>
                <li><Link href="/cars" className="hover:text-white transition-colors">شراء سيارة</Link></li>
